...
describe("validateTopicSet — topic count and order", () => {
  ...
  it("passes silently for the correct nine-topic chapter-wide order", () => {
    const diagnostics: AdapterDiagnostic[] = [];
    validateTopicSet(
      ["ch01-t01", "ch01-t02", "ch01-t03", "ch01-t04", "ch01-t05", "ch01-t06", "ch01-t07", "ch01-t08", "ch01-t10"] as any,
      diagnostics,
    );
