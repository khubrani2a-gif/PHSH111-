...
export const STRUCTURED_SLIDE_CONFIG_BY_BLOCK_ID: Partial<Record<string, StructuredSlideConfig>> = {
  ...
  // ch01-t03 (Time, Period, and Frequency) — the third real slide-bearing
  // topic (PR E). Same generic marker convention as ch01-t01/ch01-t02
  // above; nothing here is component logic, only per-blockId
  // configuration data, exactly like every entry above it.
  "ch01-t03-block-slide-1": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    scientificNoteMarker: { en: "Scientific Note:", ar: "ملاحظة علمية:" },
  ...
  "ch01-t03-block-slide-3": {
    ...
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "T = 0.5 s",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-4": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    tableExplanationMarker: { en: "Table Explanation:", ar: "شرح الجدول:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    ...
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "f = 2.0 Hz",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-5": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    relationshipExplanationMarker: { en: "Relationship Explanation:", ar: "شرح العلاقة:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    ...
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "f = 1/T = 1/0.20 s = 5.0 Hz",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-6": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    scientificNoteMarker: { en: "Scientific Note:", ar: "ملاحظة علمية:" },
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "f = 1/(0.50 s) = 2.0 Hz",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-7": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    scientificNoteMarker: { en: "Scientific Note:", ar: "ملاحظة علمية:" },
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "T = 1/(4.0 Hz) = 0.25 s",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-8": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    relationshipExplanationMarker: { en: "Relationship Explanation:", ar: "شرح العلاقة:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    ...
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: ["f = 1/0.1 s = 10 Hz", "f = 1/2.0 s = 0.5 Hz"],
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-9": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    scientificNoteMarker: { en: "Scientific Note:", ar: "ملاحظة علمية:" },
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: ["T = 0.50 s + 0.50 s = 1.00 s", "f = 1/T = 1/1.00 s = 1.00 Hz"],
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t03-block-slide-10": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
    scientificNoteMarker: { en: "Scientific Note:", ar: "ملاحظة علمية:" },
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "0.25 s × 4.0 Hz = 1",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  ...
  "ch01-t04-block-slide-4": {
    ...
    keyConceptMarker: { en: "Key Concept:", ar: "المفهوم الأساسي:" },
    connectionMarker: { en: "Connection to the Next Slide:", ar: "الصلة بالشريحة التالية:" },
    equationBlockPhrase: "W = mg = (2.0 kg)(9.8 m/s²) = 19.6 N",
    stepPattern: { en: /^Step\s+\d+\s+—[^\n]*/, ar: /^الخطوة\s+\d+\s+—[^\n]*/ },
  },
  "ch01-t04-block-slide-5": {
    mainIdeaMarker: { en: "Main Idea:", ar: "الفكرة الرئيسية:" },
    simpleExampleMarker: { en: "Simple Example:", ar: "مثال بسيط:" },
    tableExplanationMarker: { en: "Table Explanation:", ar: "شرح الجدول:" },
    misconceptionMarker: { en: "Misconception:", ar: "مفهوم خاطئ:" },
